...
\begin{figure}[H]
\center{\includegraphics[width=0.5\textwidth]{questAdding.png}\\Úkol doplňování textu}
\end{figure}
...
\begin{figure}[H]
\center{\includegraphics[width=0.5\textwidth]{questEquation.png}\\Finální úkol}
\end{figure}
\newpage
\section{Data úrovně}
